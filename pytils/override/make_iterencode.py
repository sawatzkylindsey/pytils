# COPIED VIA INSPECT, THEN MODIFIED MANUALLY
def _make_iterencode(markers, _default, _encoder, _indent, _floatstr,
    ...
    def _iterencode_list(lst, _current_indent_level, ignore_indent):
        if not lst:
            yield '[]'
            return
    ...
    def _iterencode(o, _current_indent_level):
        if isinstance(o, str):
            ...
            yield from _iterencode_list(o, _current_indent_level, False)
